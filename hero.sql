...
(1, '超级管理员', '4,5,6,9,11,19,25,7,10,12,13,14,15,16,17,18,20,21,22,23,24,26', 1),
...
--
-- 表的结构 `hero_web_document`
--

CREATE TABLE IF NOT EXISTS `hero_web_document` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
